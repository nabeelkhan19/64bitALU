...
REM
REM Generated by Vivado on Tue Oct 21 22:22:54 +0530 2025
...
echo "xvlog --incr --relax -prj tb_alu_64_vlog.prj"
call xvlog  --incr --relax -prj tb_alu_64_vlog.prj -log xvlog.log
